...
function getCategoryProducts() {
	fetchCall(`men.inc.php`, responseCategoPros);
		...
		if (products) {
			...
			if (totalNum == 0) {
				...
				<div class='unlisted' id='unlisted'>
					<h2>Looks like the Mens category is empty</h2>
...
$(document).ready(function () {
	$("#sortByMen").on("change", function () {
		var sortMen = $(this).val();
		$.ajax({
			url: "./php/sort.inc.php",
			method: "GET",
			data: { sortMen: sortMen },
