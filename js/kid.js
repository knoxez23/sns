...
function getCategoryProducts() {
	fetchCall(`kid.inc.php`, responseCategoPros);
		...
		if (products) {
			...
			if (totalNum == 0) {
				...
				<div class='unlisted' id='unlisted'>
					<h2>Looks like the Kids category is empty</h2>
...
$(document).ready(function () {
	$("#sortByKid").on("change", function () {
		var sortKid = $(this).val();
		$.ajax({
			url: "../php/sort.inc.php",
			method: "GET",
			data: { sortKid: sortKid },
